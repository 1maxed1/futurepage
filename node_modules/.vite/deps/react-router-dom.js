...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
  ...
  function handlePop() {
    ...
    if (nextIndex != null) {
      ...
      warning$1(false, "You are trying to block a POP navigation to a location that was not created by @remix-run/router. The block will fail silently in production, but in general you should do all navigation with the router (instead of using window.history.pushState directly) to avoid this situation.");
    }
  }
